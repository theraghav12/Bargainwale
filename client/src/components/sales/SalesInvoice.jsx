...
const Invoice = forwardRef(({ sales }, ref) => {
  ...
  useEffect(() => {
    const fetchPrices = async () => {
      try {
        // console.log(sales[0].sales[0], "warehouse");
        const response = await getPricesByWarehouse(
          sales[0].sales[0].warehouseId._id
        );
  ...
  let items=[];
  let count=0;
  for(const sale of sales[0].sales){
    console.log("sale_i: ",sale);
...
//           {purchase.orderId.manufacturer.manufacturerdeliveryAddress.state}
//         </p>
//         <p>
//           PIN:{" "}
//           {purchase.orderId.manufacturer.manufacturerdeliveryAddress.pinCode}
//         </p>
//       </div>
...
//             <td className="border px-4 py-2">{purchase.challanNo || "N/A"}</td>
//           </tr>
//           <tr>
//             <td className="border px-4 py-2">Supplier's Ref:</td>
//             <td className="border px-4 py-2">{purchase.supRef || "N/A"}</td>
//           </tr>
//           <tr>
//             <td className="border px-4 py-2">Other Reference:</td>
//             <td className="border px-4 py-2">{purchase.otRef || "N/A"}</td>
//           </tr>
//           <tr>
//             <td className="border px-4 py-2">Order No.:</td>
//             <td className="border px-4 py-2">{purchase.ordNo || "N/A"}</td>
//           </tr>
//           <tr>
...
//     <p>
//       <strong>Declaration:</strong> Certified that all the particulars above are
//       true.
//     </p>
//     <p>
