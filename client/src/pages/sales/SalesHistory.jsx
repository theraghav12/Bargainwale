    ...
    <Card className="mt-12">
      ...
      >
        ...
        <Link to="/dashboard/sales/create">
          <Button color="blue">Create New Sales</Button>
        </Link>
      </CardHeader>
          ...
          <table className="w-full min-w-[640px] table-auto">
            ...
            <tbody>
              {filteredSales.map((sale) => {
                ...
                const isOpen = openOrder === sale._id;
                ...
                return (
                  <React.Fragment key={sale._id}>
                    <tr>
                      ...
                      <td className={className}>
                        <Typography className="text-xs font-semibold text-center text-blue-gray-600">
                          {sale.transporterId?.transportAgency}
                        </Typography>
                      </td>
                      <td className={className}>
                        <Typography className="text-xs font-semibold text-center text-blue-gray-600">
                          {sale.transporterId?.transportContact}
                        </Typography>
                      </td>
                      <td className={className}>
                        <Typography className="text-xs font-semibold text-center text-blue-gray-600">
                      ...
                      <td className={className}>
                        <Typography className="text-xs font-semibold text-center text-blue-gray-600">
                          {sale.bookingId?.companyBargainNo}
                        </Typography>
                      </td>
                      <td className={className}>
                        <div className="flex justify-center gap-4">
                          <IconButton
                            variant="text"
                            onClick={() => handleToggleOrder(sale._id)}
