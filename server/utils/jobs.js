          ...
          <html lang="en">
            ...
            <body>
              <div class="container">
                ...
                <p>Hello,</p>
                <p>This is a reminder that your payment for the following items is due soon for seller ${
                  order.sellerName
                }. Please make sure to complete the payment to avoid any inconvenience.</p>
                    ...
                    <tbody>
                      ${order.items
                        ...
                        <tr>
                          ...
                          <td>$${(item.staticPrice * item.quantity).toFixed(
                            2
                          )}</td>
                          <td>${
...
<body>
  <div class="container">
    ...
    <p>Hello,</p>
    <p>This is a reminder that your booking for the following items is due soon for seller ${
      booking.sellerName
    }. Please make sure to complete any pending actions to avoid any inconvenience.</p>
